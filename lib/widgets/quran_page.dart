    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextfeild(),
          SizedBox(height: 10,),
          Text('Most Recently' ,style: TextStyle(color: kWhiteColor),),
          SuraContainer(),
          Padding(
            padding: const EdgeInsets.only(top: 10),
            child: Text('Sura List' , style: TextStyle(color: kWhiteColor),),
          ),
          SizedBox(height: 10,),
          Expanded(
            child: ListView.builder(
              ...
              return GestureDetector(
                onTap: (){
                  Navigator.pushNamed(context, SuraDetailsScreen.id , arguments: SuraDetailsModel(suraErName: englishQuranSurahs[index], index: index, suraArName: arabicQuranSuras[index]));
                },
                child: SuraVeiw(arabicName: arabicQuranSuras[index], englishName:englishQuranSurahs[index], ayaNumber: ayaNumber[index], index: index+1,));
            }),
          )
